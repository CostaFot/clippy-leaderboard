...
| `GET /` | The graveyard. Top 100 rows, no JavaScript; the only external request is a Google Fonts stylesheet for JetBrains Mono (Omarchy users get CaskaydiaMono if installed). |
